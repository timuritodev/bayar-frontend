...
interface ICalculatorPictureProps {
	buildingType: string; // 'односкатная' или 'двускатная'
	roofType: string;     // 'с' (с парапетом) или 'без' (без парапета)
}

const CalculatorPicture: React.FC<ICalculatorPictureProps> = ({
	buildingType,
	roofType,
}) => {
	return (
			...
			<div className={styles.calcPictureContainer}>
				<div className={styles.calcBasePic}>
					<div className={styles.house1Container}>
						...
						{buildingType === 'односкатная' && roofType === 'с' && (
							<>
								<div className={`${styles.house2Stena3} ${styles.houseControlItem} ${styles.itemHouse2}`}>
						...
						{buildingType === 'двускатная' && roofType === 'с' && (
							<>
								<div className={`${styles.house4Stena3} ${styles.houseControlItem} ${styles.itemHouse4}`}>
									{/* стена с парапетом */}
						...
						{buildingType === 'односкатная' && roofType === 'без' && (
							<>
						...
						{buildingType === 'двускатная' && roofType === 'без' && (
							<>

								<div className={`${styles.house3Stena2} ${styles.houseControlItem} ${styles.itemHouse3}`}>
						...
						{buildingType === 'односкатная' && roofType === 'без' && (
							<>
								<div className={`${styles.house1Krisha} ${styles.houseControlItem} ${styles.itemHouse1}`}>
									{/* односкатная крыша без парапета */}
						...
						{buildingType === 'односкатная' && roofType === 'с' && (
							<>
								<div className={`${styles.house2Stena4} ${styles.houseControlItem} ${styles.itemHouse2}`}>
						...
						{buildingType === 'односкатная' && roofType === 'с' && (
							<>
								<div className={`${styles.house2Krisha} ${styles.houseControlItem} ${styles.itemHouse2}`}>
									{/* односкатная крыша с парапетом */}
						...
						{buildingType === 'двускатная' && roofType === 'с' && (
							<>
								<div className={`${styles.house4Krisha} ${styles.houseControlItem} ${styles.itemHouse4}`}>
									{/* двускатная крыша */}
						...
						{buildingType === 'односкатная' && roofType === 'с' && (
							<>
								<div className={`${styles.house2Stena2} ${styles.houseControlItem} ${styles.itemHouse2}`}>
									{/* стена с парапетом 2 */}
						...
						{buildingType === 'двускатная' && roofType === 'с' && (
							<>
								<div className={`${styles.house4Stena2} ${styles.houseControlItem} ${styles.itemHouse4}`}>
									<svg width="204" height="211" viewBox="0 0 204 211" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						{buildingType === 'двускатная' && roofType === 'без' && (
							<>
								<div className={`${styles.house3Krisha} ${styles.houseControlItem} ${styles.itemHouse3}`}>
									{/* двускатная крыша */}
